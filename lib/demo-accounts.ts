...
export const DEMO_ACCOUNTS = [
  { email: "superadmin@edumawu.com", label: "Super Administrator", description: "Platform-wide: schools, RBAC, national analytics" },
  ...
  { email: "vacation@edumawu.com", label: "Vacation Classes Coordinator", description: "Bundles, registrations, payments, teacher matching" },
